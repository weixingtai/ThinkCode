...
import com.think.design.adaptive.AdaptiveListViewDemoFragment.EmailData.Email;
...
public class AdaptiveListViewDemoFragment extends Fragment {
  ...
  private void setEmailSelected(long emailId, boolean selected) {
    ...
    EmailAdapter.EmailViewHolder emailViewHolder = (EmailAdapter.EmailViewHolder) emailList.findViewHolderForItemId(emailId);
