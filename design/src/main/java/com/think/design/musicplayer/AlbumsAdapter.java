...
package com.think.design.musicplayer;
...
import com.think.design.musicplayer.AlbumsAdapter.AlbumViewHolder;
...
class AlbumsAdapter extends ListAdapter<Album, AlbumsAdapter.AlbumViewHolder> {
